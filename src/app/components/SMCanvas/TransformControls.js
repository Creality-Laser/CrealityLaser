...
class TransformControls extends Object3D {
  ...
  initDefaults() {
    ...
    this.defaults.LINE.addAttribute(
      'position',
  ...
  initTranslatePeripherals() {
    ...
    this.translatePeripheral = this.createPeripheral([
      [
        'X',
        new Line(defaults.LINE.clone(), defaults.LINE_MATERIAL_RED.clone()),
      ],
      [
        'X',
        new Mesh(defaults.ARROW.clone(), defaults.MESH_MATERIAL_RED.clone()),
        [1, 0, 0],
        [0, 0, -Math.PI / 2],
      ],
      [
        'Y',
        new Line(defaults.LINE.clone(), defaults.LINE_MATERIAL_GREEN.clone()),
        null,
        [0, 0, Math.PI / 2],
      ],
      [
        'Y',
        new Mesh(defaults.ARROW.clone(), defaults.MESH_MATERIAL_GREEN.clone()),
        [0, 1, 0],
      ],
      [
        'Z',
        new Line(defaults.LINE.clone(), defaults.LINE_MATERIAL_BLUE.clone()),
        null,
        [0, -Math.PI / 2, 0],
      ],
      [
        'Z',
        new Mesh(defaults.ARROW.clone(), defaults.MESH_MATERIAL_BLUE.clone()),
        [0, 0, 1],
        [Math.PI / 2, 0, 0],
      ],
    ]);
    ...
    this.translatePicker = this.createPeripheral([
      [
        'X',
        new Mesh(
          defaults.TRANSLATE_PICKER.clone(),
          defaults.MESH_MATERIAL_INVISIBLE
        ),
        [0.6, 0, 0],
        [0, 0, -Math.PI / 2],
      ],
  ...
  initRotatePeripherals() {
    ...
    this.rotatePeripheral = this.createPeripheral([
      [
        'X',
        new Line(
          new ArcBufferGeometry(1, 64, Math.PI),
          defaults.LINE_MATERIAL_RED.clone()
        ),
        null,
        [Math.PI, Math.PI / 2, 0],
      ],
      [
        ...
        new Mesh(
          ...
          defaults.MESH_MATERIAL_RED.clone()
        ),
        [0, -0.99, 0],
        [Math.PI / 2, 0, 0],
        [1, 3, 1],
      ...
      [
        ...
        new Line(
          new ArcBufferGeometry(1, 64, Math.PI),
          defaults.LINE_MATERIAL_GREEN.clone()
        ),
        null,
        [Math.PI / 2, 0, 0],
      ],
      [
        ...
        new Mesh(
          new OctahedronBufferGeometry(0.04, 0),
          defaults.MESH_MATERIAL_GREEN.clone()
        ),
        [0, 0, 0.99],
        [0, 0, Math.PI / 2],
        [1, 3, 1],
      ...
      [
        ...
        new Line(
          new ArcBufferGeometry(1, 64, Math.PI),
          defaults.LINE_MATERIAL_BLUE.clone()
        ),
        null,
        [Math.PI, 0, 0],
      ],
      [
        ...
        new Mesh(
          new OctahedronBufferGeometry(0.04, 0),
          defaults.MESH_MATERIAL_BLUE.clone()
        ),
        [0, -0.99, 0],
        [0, 0, Math.PI / 2],
        [1, 3, 1],
      ...
      [
        'XYZE',
        new Line(
          new ArcBufferGeometry(1, 64, Math.PI * 2),
          defaults.LINE_MATERIAL_GRAY.clone()
        ),
        null,
        [0, 0, 0],
      ],
  ...
  initScalePeripherals() {
    ...
    this.scalePeripheral = this.createPeripheral([
      ...
      [
        'X',
        new Mesh(defaults.BOX.clone(), defaults.MESH_MATERIAL_RED.clone()),
        [1, 0, 0],
        [0, 0, -Math.PI / 2],
      ],
      [
      ...
      [
        'Y',
        new Mesh(defaults.BOX.clone(), defaults.MESH_MATERIAL_GREEN.clone()),
        [0, 1, 0],
      ],
      [
        'Z',
      ...
      [
        'Z',
        new Mesh(defaults.BOX.clone(), defaults.MESH_MATERIAL_BLUE.clone()),
        [0, 0, 1],
        [Math.PI / 2, 0, 0],
      ],
    ]);
  ...
  updateMatrixWorld(force) {
    if (this.object) {
      ...
      if (this.mode === 'translate') {
        ...
        this.translatePeripheral.scale
          .set(1, 1, 1)
          .multiplyScalar(eyeDistance / 8);
        ...
        if (this.mode === 'rotate') {
          ...
          if (handle.label === 'X') {
            const quaternion = new Quaternion().setFromAxisAngle(
              unitX,
              Math.atan2(-alignVector.z, -alignVector.y)
            );
            ...
            const quaternion = new Quaternion().setFromAxisAngle(
              unitZ,
              Math.atan2(alignVector.x, -alignVector.y)
            );
            handle.quaternion.copy(quaternion);
      ...
      if (this.mode === 'translate') {
        ...
        const unitXLocal = new Vector3(1, 0, 0).applyQuaternion(
          objectQuaternion
        );
        const unitYLocal = new Vector3(0, 1, 0).applyQuaternion(
          objectQuaternion
        );
        const unitZLocal = new Vector3(0, 0, 1).applyQuaternion(
          objectQuaternion
        );
    ...
    switch (this.mode) {
      ...
      case 'rotate': {
        ...
        const objectPosition = new Vector3()
          ...
          .applyMatrix4(this.object.parent.matrixWorld); // TODO: optimize?
        ...
        const rotationAngle =
          offset.dot(
            new Vector3().crossVectors(rotationAxis, cameraPosition).normalize()
          ) * ROTATION_SPEED;
      ...
      case 'scale': {
        ...
        const sVec = new Vector3()
          .copy(this.pointStart)
          .sub(objectPosition)
          .applyQuaternion(this.objectQuaternionInv);
