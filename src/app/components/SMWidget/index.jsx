...
function createDefaultWidget(WrappedWidget) {
  ...
  const mapDispatchToProps = (dispatch) => ({
    updateWidgetState: (widgetId, key, value) =>
      dispatch(widgetActions.updateWidgetState(widgetId, key, value)),
  });

  class SMComponent extends PureComponent {
    state = {
      title: '',
      display: true,
  ...
  SMComponent.displayName = 'SMComponent';

  return connect(mapStateToProps, mapDispatchToProps)(SMComponent);
}
