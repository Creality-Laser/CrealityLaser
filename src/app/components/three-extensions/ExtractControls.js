...
function ExtractControls(camera, domElement, remapBox2, cornerPositions) {
  ...
  function updateSize(size) {
    ...
    const padding = 5;
    cornerPositions = {
      leftTop: new THREE.Vector3(
        -size.x / 2 + padding,
        size.y / 2 - padding,
        0
      ),
      leftBottom: new THREE.Vector3(
        -size.x / 2 + padding,
        -size.y / 2 + padding,
        0
      ),
      rightBottom: new THREE.Vector3(
        size.x / 2 - padding,
        -size.y / 2 + padding,
        0
      ),
      rightTop: new THREE.Vector3(
        size.x / 2 - padding,
        size.y / 2 - padding,
        0
      ),
...
ExtractControls.prototype = Object.assign(
