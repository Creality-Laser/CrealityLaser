...
class ToolPathModelGroup {
  ...
  updateSelectedPrintOrder(printOrder) {
    this.selectedToolPathModel &&
      (this.selectedToolPathModel.printOrder = printOrder);
  }
  ...
  updateSelectedNeedPreview(param) {
    this.selectedToolPathModel &&
      this.selectedToolPathModel.updateNeedPreview(param);
  }
  ...
  hideSelectedModel() {
    ...
    selectedToolPathModel.toolPathObj3D &&
      (selectedToolPathModel.toolPathObj3D.visible = false);
  }
  ...
  showSelectedModel() {
    ...
    selectedToolPathModel.updateNeedPreview(true);
    selectedToolPathModel.toolPathObj3D &&
      (selectedToolPathModel.toolPathObj3D.visible = true);
  }
}
