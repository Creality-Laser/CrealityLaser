...
const DEFAULT_STATE = {
  ...
  laser: {
    default: {
      widgets: [
        'cnc-laser-object-list',
        // 'laser-set-background',
        'laser-params',
        'laser-output',
      ],
    },
...
class WidgetState {
  ...
  versionCompatibility(widgetState) {
    ...
    if (
      !arrayEqual(
        widgetState.defaultState['3dp'].default.widgets,
        DEFAULT_STATE['3dp'].default.widgets
      )
    ) {
      widgetState.defaultState['3dp'].default.widgets =
        DEFAULT_STATE['3dp'].default.widgets;
    ...
    if (
      !arrayEqual(
        widgetState.defaultState.laser.default.widgets,
        DEFAULT_STATE.laser.default.widgets
      )
    ) {
      widgetState.defaultState.laser.default.widgets =
        DEFAULT_STATE.laser.default.widgets;
    ...
    if (
      !arrayEqual(
        widgetState.defaultState.cnc.default.widgets,
        DEFAULT_STATE.cnc.default.widgets
      )
    ) {
      widgetState.defaultState.cnc.default.widgets =
        DEFAULT_STATE.cnc.default.widgets;
    ...
    if (
      !arrayEqual(
        ...
        SERIES_STATES.A150.laser.default.widgets
      )
    ) {
      widgetState.seriesStates.A150.laser.default.widgets =
        SERIES_STATES.A150.laser.default.widgets;
    ...
    if (
      !arrayEqual(
        widgetState.seriesStates.A250.laser.default.widgets,
        SERIES_STATES.A250.laser.default.widgets
      )
    ) {
      widgetState.seriesStates.A250.laser.default.widgets =
        SERIES_STATES.A250.laser.default.widgets;
    ...
    if (
      !arrayEqual(
        widgetState.seriesStates.A350.laser.default.widgets,
        SERIES_STATES.A350.laser.default.widgets
      )
    ) {
      widgetState.seriesStates.A350.laser.default.widgets =
        SERIES_STATES.A350.laser.default.widgets;
    ...
    if (_.has(machineSeriesState, path)) {
      ...
      const v =
        typeof newVar === 'object'
          ? merge(_.isArray(newVar) ? [] : {}, newVar, value)
          : value;
  ...
  getState() {
    return merge(
      {},
      this.widgetState.defaultState,
      this.widgetState.seriesStates[this.series]
    );
  }
}
