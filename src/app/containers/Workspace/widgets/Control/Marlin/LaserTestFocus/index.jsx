...
import { Button, Modal, InputNumber as Input, Popover } from 'antd';

import StyledSlider from '../../../../../../widgets/components/params/StyledSlider';
...
class TestFocus extends PureComponent {
  ...
  actions = {
    ...
    setLaserFocusZ: () => {
      ...
      const gcodes = [`G0 Z${z} F100`, 'G92 X0 Y0 Z0'];
      ...
      <>
        {this.state.showInstructions && (
          <Modal
            style={{ width: '960px' }}
            size="lg"
            onClose={actions.hideInstructions}
          >
            <Modal.Header>
              <Modal.Title>
            ...
            <Modal.Body
              className={innerStyles['test-laser-instruction-content']}
            >
              <p>
                {i18n._(
...
on the same material. The best result determines the best Z Offset.`
              ...
              <div
                className={innerStyles['test-laser-instruction-step-wrapper']}
              >
                <div className={innerStyles['test-laser-instruction-step']}>
                  <span
                    className={
                      innerStyles['test-laser-instruction-step-indicator']
                    }
                  >
                    1
                  </span>
                  ...
                  />
                  <p
                    className={innerStyles['test-laser-instruction-step-text']}
                  >
                    <span>{i18n._('Click')}</span>
                    <span style={{ color: '#193BDE', padding: '0 4px' }}>
                      {i18n._('Focus')}
                    </span>
                    ...
                    <span>
                      {i18n._(
                        `in the Axes section to move the Laser Cutting Module to the position \
that is close to the optimal Z Offset (just like how you do with the 200mW Laser Engraving Module).`
                ...
                <div className={innerStyles['test-laser-instruction-step']}>
                  ...
                  >
                    <span>
                      {i18n._(
                        `Set Work Speed and Power based on the material you are using. If you are using \
a piece of 1.5 mm wood sheet, it’s recommended to set the Work Speed to a value between 80 mm/s and 120 mm/s and set the Power to 100%.`
                    ...
                    <span>
                      {i18n._(
                        'and the G-code is automatically generated and loaded.'
                      )}
                    </span>
                  </p>
                </div>
                <div className={innerStyles['test-laser-instruction-step']}>
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ padding: '0 4px', color: '#193BDE' }}
                    />
                    <span>{i18n._('to start laser cutting.')}</span>
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <span>
                      {i18n._(
                        `Choose the position that can cut the material the most smoothly or \
engrave the thinnest line and the software will set it as Z Offset. In this example, -2.0 should be the Z Offset.`
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={innerStyles.labelWrapper}>
            ...
            >
              <i className={classNames('iconfont', innerStyles.labelIcon)}>
                &#xe6b2;
              </i>
            </span>
        ...
        <div className={innerStyles.zBlockWrapper}>
                ...
                <span className={innerStyles.zBlockItem} key={zValue}>
                  <span
                    className={classNames(
                      innerStyles.zBlockItemText,
                      this.state.z === zValue
                        ? innerStyles.zBlockItemTextActived
                        : ''
                    )}
                  >
                    {zValue.toFixed(1)}
                  ...
                  <button
                    ...
                    className={classNames(
                      innerStyles.zBlockItemCube,
                      this.state.z === zValue
                        ? innerStyles.zBlockItemCubeActived
                        : ''
                    )}
                  />
                </span>
          ...
          <div
            className={innerStyles.zBlockRow}
...
const mapDispatchToProps = (dispatch) => ({
  renderGcode: (name, gcode) =>
    dispatch(workspaceActions.renderGcode(name, gcode)),
