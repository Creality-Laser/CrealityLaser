...
class Laser extends PureComponent {
    ...
    render() {
        ...
        const { laserPowerOpen, laserPower, workSpeed, workSpeedValue } = this.state;
                ...
                {connectionType === CONNECTION_TYPE_WIFI && (
                    <React.Fragment>
                        <div className={styles.contentItem}>
                            <span className={styles.contentItemLabel}>{i18n._('Printing Auto Mode')}</span>
                            <span className={styles.contentItemContent}>
                                <Checkbox isChecked={isLaserPrintAutoMode} onChange={actions.onChangeLaserPrintMode} />
                            </span>
                        </div>
                        {isLaserPrintAutoMode && (
                            <div className={styles.contentItem}>
                                <span className={styles.contentItemLabel}>{i18n._('Material Thickness')}</span>
                                <span className={styles.contentItemContent}>
                                    <Input
                        ...
                        <React.Fragment>
                            <div className={styles.contentItem}>
                                <span className={styles.contentItemLabel}>{i18n._('Laser Focus')}</span>
                                <span className={styles.contentItemContent}>
                                    <span>
                                        {laserFocalLength}
                                    </span>
