...
class JogPad extends PureComponent {
  ...
  render() {
    ...
    const isCustomDistanceSelected = !_.includes(
      ['10', '1', '0.1', '0.05'],
      selectedDistance
    );
                ...
                return (
                  <span
                    ...
                    className={classNames(
                      styles.jogpadScaleItem,
                      jogSpeed === value ? styles.jogpadScaleItemActived : ''
                    )}
                  >
                    {label}
                  </span>
              ...
              {jogDistanceItems.map(({ label, value }) => {
                return (
                  <span
                    ...
                    className={classNames(
                      styles.jogpadScaleItem,
                      Number(selectedDistance) === Number(value)
                        ? styles.jogpadScaleItemActived
                        : ''
                    )}
                    key={label}
                    onClick={() => {
          ...
          <div className={classNames(styles.jogpadCol, styles.jogpadCol3)}>
            <div className={classNames(styles.jogpadBtnsWrapper)}>
              <span
                ...
                className={classNames(
                  styles.jogpadBtn,
                  styles.jogpadBtnCircle,
                  !canClick ? styles.jogpadBtnDisabled : ''
                )}
              ...
              <span
                ...
                className={classNames(
                  styles.jogpadBtn,
                  styles.jogpadBtnTriangle,
                  !canClick ? styles.jogpadBtnDisabled : ''
                )}
                title={i18n._('Move Y+')}
              >
                <span
                  className={classNames(styles.jogpadBtnTriangleBackground)}
                >
                  <RoundedTriangleBtn />
                </span>
                <span className={classNames(styles.jogpadBtnTriangleLabel)}>
                  Y+
                </span>
              </span>
              <span
            ...
            <div className={classNames(styles.jogpadBtnsWrapper)}>
              ...
              >
                <span
                  className={classNames(
                    styles.jogpadBtnTriangleBackground,
                    styles.jogpadBtnTriangleBackgroundLeft
                  )}
                >
                  <RoundedTriangleBtn />
                </span>
              ...
              >
                <span
                  className={classNames(
                    styles.jogpadBtnTriangleBackground,
                    styles.jogpadBtnTriangleBackgroundRight
                  )}
                >
                  <RoundedTriangleBtn />
                </span>
            ...
            <div className={classNames(styles.jogpadBtnsWrapper)}>
              ...
              >
                <span
                  className={classNames(
                    styles.jogpadBtnTriangleBackground,
                    styles.jogpadBtnTriangleBackgroundBottom
                  )}
                >
                  <RoundedTriangleBtn />
                </span>
        ...
        <div className={styles.customDistanceRow}>
          ...
          <span className={styles.customDistanceRowInputGroup}>
            ...
            <input
              ...
              step={DISTANCE_STEP}
              className={classNames(
                styles.customDistanceRowInput,
                !isCustomDistanceSelected
                  ? styles.customDistanceRowInputDisabled
                  : ''
              )}
              disabled={!isCustomDistanceSelected}
