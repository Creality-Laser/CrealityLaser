...
class TerminalWrapper extends PureComponent {
  ...
  componentDidMount() {
    ...
    xtermElement.style.overflowX = 'hidden';
  ...
  resize() {
    ...
    if (!(this.term && this.term.element && this.terminalContainer)) {
      return;
    }
    ...
    const rowOffset = 2;
    const height =
      this.terminalContainer.current.parentElement.clientHeight < 300
        ? 300
        : this.terminalContainer.current.parentElement.clientHeight;
  ...
  render() {
    const { isDefault, terminalHistory, isMaximized } = this.props;
    ...
    return (
      ...
      >
        ...
        <input
          ...
          value={
            terminalHistory.get(0) === undefined
              ? inputValue
              : terminalHistory.get(0)
          }
