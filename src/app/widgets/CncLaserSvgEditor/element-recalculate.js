...
function recalculateDimensions(root, elem) {
  ...
  if (
    n >= 3 &&
    transformList.getItem(n - 2).type === 3 &&
    transformList.getItem(n - 3).type === 2 &&
  ...
  if (operation === 2 || operation === 3) {
    ...
    if (
      transformList.numberOfItems >= 1 &&
      transformList.getItem(0).type === 4
    ) {
...
export { remapElement, recalculateDimensions };
