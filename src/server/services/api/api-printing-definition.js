...
//   const series = isDefaultQualityDefinition(definitionId)
//     ? req.query.series
//     : '';
//   if (!definitionId) {
...
//   res.send({ filename, definition: parse });
// };
...
//   const series = isDefaultQualityDefinition(definition.definitionId)
//     ? req.body.series
//     : '';
...
//     `${DataStorage.configDir}/${series}`,
//     `${definitionLoader.definitionId}.def.json`
//   );
//   fs.writeFile(
//     filePath,
//     JSON.stringify(definitionLoader.toJSON(), null, 2),
//     'utf8',
//     (err) => {
//       if (err) {
